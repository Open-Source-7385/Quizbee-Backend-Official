package pe.edu.upc.quizbee.profiles.interfaces.rest;
...
import pe.edu.upc.quizbee.profiles.domain.model.queries.GetAllProfilesQuery;
import pe.edu.upc.quizbee.profiles.domain.model.queries.GetProfileByIdQuery;
import pe.edu.upc.quizbee.profiles.domain.services.ProfileCommandService;
import pe.edu.upc.quizbee.profiles.domain.services.ProfileQueryService;
...
import pe.edu.upc.quizbee.profiles.interfaces.rest.transform.CreateProfileCommandFromResourceAssembler;
import pe.edu.upc.quizbee.profiles.interfaces.rest.transform.ProfileResourceFromEntityAssembler;
